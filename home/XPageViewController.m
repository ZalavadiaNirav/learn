...
-(id)init{
    ...
    XScrollView.userInteractionEnabled=true;
    XScrollView.bounces = false;
    XScrollView.delegate = self;
    [self.view addSubview:XScrollView];
    PageBar = [[XPageBar alloc] initWithFrame:CGRectMake(0, 0, width, 44)];
    [PageBar setBackgroundColor:[UIColor colorWithRed:(16.0/255.0) green:(56.0/255.0) blue:(102.0/255.0) alpha:1.0]];
  
    PageBar.target = self;
    PageBar.userInteractionEnabled=true;
//    [PageBar setSelectIndex:4];
//    [PageBar se]
